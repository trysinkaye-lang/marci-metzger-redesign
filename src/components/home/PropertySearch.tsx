    ...
    <section id="property-search" className="section search-section" aria-labelledby="search-heading" tabIndex={-1}>
      <Container>
        <div className="search-story">
          <img src="/images/property-search.jpg" alt="" width="2121" height="1414" loading="lazy" />
          <div className="search-story-overlay" aria-hidden="true" />
          <div className="search-story-copy">
            <p className="eyebrow">Your next address</p>
            <h2 id="search-heading">{content.title}</h2>
            <p className="search-story-note">Pahrump, Nevada</p>
          </div>
        </div>
        ...
        <div className="search-panel">
          <div className="search-panel-heading">
            ...
            <span className="section-note">Preview only</span>
          </div>

          <form aria-label={content.subtitle} aria-describedby="search-status" onSubmit={(event) => event.preventDefault()}>
            <fieldset disabled aria-describedby="search-status">
              <legend className="visually-hidden">Listing search preview</legend>
